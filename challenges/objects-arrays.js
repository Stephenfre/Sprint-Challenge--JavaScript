...
const dinoRawr = {
  greeting: "RAWERSRARARWERSARARARRRR!",
  dinoTalk: function() {
...
const universities = graduates.map(state => {
...
zooAnimals.forEach(element => {
  animalNames.push(
    `${element.scientific_name}, ${element.animal_name}, ${element.state}`
  );
});
